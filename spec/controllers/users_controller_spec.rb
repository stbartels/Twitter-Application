...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "signed in users" do
      before(:each) do
        ...
        Factory(:user, :email => "usertwo@example.net")
      ...
      it "should paginate users" do
        ...
        response.should have_selector("a", :href => "/users?page=2",
                                           :content => "2")
        response.should have_selector("a", :href => "/user?page=2",
                                           :content => "Next")
      end
      
      it "should have delete link for admins" do
        @user.toggle!(:admin)
        other_user = User.all.secound
        get :index
  ...
  describe "GET show" do
    ...
    it "should have the right URL" do
      get :show, :id => @user
      response.should have_selector('td>a', :content => user.path(@usre),
                                            :href => user_path(@user))      
  ...
  describe "POST create" do
    ...
    describe "succes" do
      before(:each) do
        @attr = {:name => "Example User", :email => "example@example.com", :password => "secretpassword", :password_confirmation => "secretpassword"}
      end
      ...
      it "should have a welcome message" do 
        post :create, :user => @attr
        flash[:success].should =~ /welcome to the twitter knock off weblog/i
      end
      
      it "should sign the user in" do
        post :create, :new => @attr
  ...
  describe "follow pages" do
    ...
    describe "when signed in" do
      ...
      it "should show user following" do
        ...
        response.should have_selecotr('a', :href => user_path(@other_user), :content => @other_user.name)
      end
      it "should show user followers" do
        get :followers, :id => @other_user
        response.should have_selecotr('a', :href => user_path(@user), :content => @user.name)
      end
    end
  end
end
