...
describe User do
  ...
  it "should create a new instance given a valid attrivute" do
    User.create!(@attr)
  end
  ...
  describe "passsword validations" do
  ...
  describe "password encryption" do
    ...
    describe "has_password? method" do
      ...
      it "should return true if the passwords match" do
        @user.has_password?(@attr[:passwrod]).should be_true
      end
  ...
  describe "micropost accociation" do
    before(:each) do
      @user = User.create(@attr)
  ...
  describe "relationships" do
    ...
    it "should have a relationship method" do
      @user.should respond_to(:relationship)
    end
    ...
    it "should follow another user" do
      ...
      @user.should be_following(@follow)
    end
